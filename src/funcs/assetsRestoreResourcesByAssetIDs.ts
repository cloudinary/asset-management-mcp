...
import { RestoreResourcesByAssetIDsOpServerList } from "../models/restoreresourcesbyassetidsop.js";
...
> {
  ...
  const baseURL$ = options?.serverURL
    || pathToFunc(RestoreResourcesByAssetIDsOpServerList[0], {
