...
import {
  ArchiveDeliveryType,
  ArchiveDeliveryType$zodSchema,
} from "./archivedeliverytype.js";
import {
...
export const ExplicitRequestAccessMode$zodSchema = z.enum([
  "public",
  "authenticated",
]).describe(
  "Deprecated. Use access_control instead. Allows the asset to behave as if it's of the authenticated delivery type while still using the default 'upload' type in delivery URLs. The asset can later be made public by changing its access_mode via the Admin API, without having to update any delivery URLs.\n",
...
export const ExplicitRequestRegions$zodSchema: z.ZodType<
...
export const ExplicitRequestResponsiveBreakpoints$zodSchema: z.ZodType<
...
export type ExplicitRequest = {
  ...
  auto_transcription?: boolean | ExplicitRequestAutoTranscription | undefined;
  ...
  type?: ArchiveDeliveryType | undefined;
...
export const ExplicitRequest$zodSchema: z.ZodType<ExplicitRequest> = z.object({
  ...
  access_mode: ExplicitRequestAccessMode$zodSchema.optional().describe(
    "Deprecated. Use access_control instead. Allows the asset to behave as if it's of the authenticated delivery type while still using the default 'upload' type in delivery URLs. The asset can later be made public by changing its access_mode via the Admin API, without having to update any delivery URLs.\n",
  ),
  ...
  type: ArchiveDeliveryType$zodSchema.optional().describe(
