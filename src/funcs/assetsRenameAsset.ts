...
> {
  ...
  const parsed$ = safeParse(
    input$,
    (value$) => RenameAssetRequest$zodSchema.parse(value$),
  ...
  const baseURL$ = options?.serverURL
    || pathToFunc(RenameAssetOpServerList[0], { charEncoding: "percent" })(
      {
        region: "api",
