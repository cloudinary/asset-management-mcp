...
export const ListPeopleRequest$zodSchema: z.ZodType<ListPeopleRequest> = z
  .object({
    direction: ParametersDirection$zodSchema.optional(),
    ...
    name_status: NameStatus$zodSchema.default("all"),
    ...
    sort_by: ListPeopleSortBy$zodSchema.default("name"),
...
> = z.object({
  ...
  people: z.array(PersonDetails$zodSchema).optional(),
