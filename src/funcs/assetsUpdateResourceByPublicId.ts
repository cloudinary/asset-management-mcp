...
export function assetsUpdateResourceByPublicId(
  ...
  security: UpdateResourceByPublicIdSecurity,
...
> {
  const input$: UpdateResourceByPublicIdRequest = {
  ...
  const baseURL$ = options?.serverURL
    || pathToFunc(UpdateResourceByPublicIdOpServerList[0], {
