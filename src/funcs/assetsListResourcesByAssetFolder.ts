...
import {
  ...
  ListResourcesByAssetFolderResponse$zodSchema,
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ListResourcesByAssetFolderResponse$zodSchema, {
      key: "list_response",
    }),
    M.json([400, 401, 404], ListResourcesByAssetFolderResponse$zodSchema, {
      key: "api_error",
    }),
