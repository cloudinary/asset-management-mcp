...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetPersonResponse$zodSchema, { key: "person_response" }),
    M.json([400, 401, 403, 404], GetPersonResponse$zodSchema, {
      key: "api_error",
    }),
