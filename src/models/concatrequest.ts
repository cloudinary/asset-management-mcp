...
export const ConcatRequestAccessMode$zodSchema = z.enum([
  "public",
  "authenticated",
]).describe(
  "Deprecated. Use access_control instead. Allows the asset to behave as if it's of the authenticated delivery type while still using the default 'upload' type in delivery URLs. The asset can later be made public by changing its access_mode via the Admin API, without having to update any delivery URLs.\n",
...
export const ConcatRequestAutoTranscription$zodSchema: z.ZodType<
...
export const ConcatRequestAutoTranscriptionUnion$zodSchema: z.ZodType<
  ConcatRequestAutoTranscriptionUnion
> = z.union([
  z.boolean(),
  z.lazy(() => ConcatRequestAutoTranscription$zodSchema),
]);
...
export const ConcatRequestRegions$zodSchema: z.ZodType<ConcatRequestRegions> = z
  .union([
    z.string(),
...
export const ConcatRequestResponsiveBreakpoints$zodSchema: z.ZodType<
...
export type ConcatRequest = {
  ...
  auto_transcription?: boolean | ConcatRequestAutoTranscription | undefined;
  access_control?: Array<AccessControlItem> | undefined;
  access_mode?: ConcatRequestAccessMode | undefined;
...
export const ConcatRequest$zodSchema: z.ZodType<ConcatRequest> = z.object({
  ...
  access_mode: ConcatRequestAccessMode$zodSchema.optional().describe(
    "Deprecated. Use access_control instead. Allows the asset to behave as if it's of the authenticated delivery type while still using the default 'upload' type in delivery URLs. The asset can later be made public by changing its access_mode via the Admin API, without having to update any delivery URLs.\n",
  ),
