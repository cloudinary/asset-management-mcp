...
export const ManagedAssetStorageResourceType$zodSchema = z.enum([
  "image",
  "video",
  "raw",
...
export type ManagedAssetStorage = {
  ...
  public_id: string;
  resource_type: ManagedAssetStorageResourceType;
  type: string;
  version: number;
};
...
export const ManagedAssetStorage$zodSchema: z.ZodType<ManagedAssetStorage> = z
  .object({
    ...
    resource_type: ManagedAssetStorageResourceType$zodSchema.describe(
      "Cloudinary resource type of the stored asset.",
    ),
