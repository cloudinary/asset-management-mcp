...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ListPeopleResponse$zodSchema, { key: "people_list_response" }),
    M.json([400, 401, 403], ListPeopleResponse$zodSchema, { key: "api_error" }),
