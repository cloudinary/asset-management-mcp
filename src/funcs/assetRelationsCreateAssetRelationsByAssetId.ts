...
import {
  ...
  CreateAssetRelationsByAssetIdResponse$zodSchema,
...
> {
  ...
  const parsed$ = safeParse(
    input$,
    (value$) => CreateAssetRelationsByAssetIdRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json([200, 207], CreateAssetRelationsByAssetIdResponse$zodSchema, {
      key: "asset_relations_response",
    }),
    M.json([400, 401, 404], CreateAssetRelationsByAssetIdResponse$zodSchema, {
      key: "api_error",
    }),
