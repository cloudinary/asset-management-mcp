...
import {
  ...
  DestroyByAssetIdResponseResponse$zodSchema,
...
> {
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, DestroyByAssetIdResponseResponse$zodSchema, {
      key: "destroy_by_asset_id_response",
    }),
    M.json([400, 401, 403], DestroyByAssetIdResponseResponse$zodSchema, {
      key: "api_error",
    }),
