...
import { UploadNoResourceTypeOpServerList } from "../models/uploadnoresourcetypeop.js";
import {
  UploadRequest,
  UploadRequest$zodSchema,
} from "../models/uploadrequest.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UploadRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/v1_1/{cloud_name}/upload")(
    pathParams$,
  );
